...
do
    ...
    do
        ...
        /usr/bin/time -f "%e %M" -o $TIME_MEM_FILE parallel --timeout $SECONDS PYTHONPATH=../.. python ../../benchmarking.py --neutral_mutations --popsize $N --theta $size --rho $size --nsam 100 --pdel 0.01 --gc $GC --seed ::: 42 > $DETAILED_TIME_FILE
    done
done
